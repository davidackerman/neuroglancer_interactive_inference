...
class InteractiveInference(object):
    def __init__(self):
        ...
        self.raw_vol = neuroglancer.ImageLayer(
            source="n5://s3://janelia-cosem-datasets/jrc_mus-liver/jrc_mus-liver.n5/em/fibsem-uint8",
        )
        self.raw_vol.shape()
        print(self.raw_vol.shape, self.raw_vol.layerDimensions)
        # print(self.raw_vol.layer_dimensions)
